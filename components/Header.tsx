...
export default function Header() {
  return (
    <header className='fixed inset-x-0 top-0 z-50 bg-background/75 py-6 backdrop-blur-sm'>
      <nav className='text-theme-gray-shade font-proxima container flex max-w-3xl items-center justify-between text-[0.9rem] font-bold uppercase leading-[30px] tracking-[0.15rem]'>
        <div>
          <Link
            href='/'
