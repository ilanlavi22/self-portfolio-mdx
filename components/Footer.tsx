...
const navigation = [
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/ilanlavi/',
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/ilanlavi22',
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
  ...
  {
    name: 'Email',
    href: 'mailto:refaelberlin@gmail.com',
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
      <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
...
export default function Footer() {
  return (
    <footer className='bg-theme-dark-gray p-12'>
      <div className='mx-auto max-w-3xl'>
        <div className='items-center gap-10 md:flex md:justify-center'>
